...
export const CASE_CONFIRMDATE = 'CASE_CONFIRMDATE';
...
export const SRPAGE_SWITCH = 'SRPAGE_SWITCH';
export const SRINQUIRY_SUPPLIER_UPDATE = 'SRINQUIRY_SUPPLIER_UPDATE';
export const TOGGLE_PRICELIST = 'TOGGLE_PRICELIST'
//@ quo
...
export const QUOFORM_REPLACE_ONE = 'QUOFORM_REPLACE_ONE';
export const MARGIN_MTRL = 'MARGIN_MTRL';
